...
{
    [CustomEditor(typeof(AutoStoryTrigger))]
    public class AutoStoryTriggerEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.HelpBox(
                "Auto Story Trigger активується автоматично при вході в колайдер.\n" +
                "Не потребує взаємодії від гравця, не показує візуальну підказку.",
                MessageType.Info);
            ...
            EditorGUILayout.PropertyField(_activationDelayProperty, new GUIContent("Activation Delay (seconds)"));
