...
public class PlayerControllerDI : InjectableMonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        var shouldStopMovement = /*(dialogueManager?.IsDialoguePlaying ?? false) || */
    ...
    void OnMove(InputValue value)
    {
        if (animator != null)
        {
            ...
            bool shouldBlockInput = (gameState?.isTransitionAnimationPlaying ?? false/*) || 
                                   (dialogueManager?.IsDialoguePlaying ?? false*/);
